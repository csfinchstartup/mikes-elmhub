...
Elm.ElmHub.make = function (_elm) {
   ...
   var serverResponseDecoder = A3($Json$Decode$Pipeline.required,
   "last_updated",
   $Json$Decode.string,
   ...
   var repoFeed = function (userName) {
      ...
      var task = A3(performAction,HandleRepoResponse,HandleRepoError,A2($Http.get,responseDecoder,url));
   ...
   return _elm.ElmHub.values = {_op: _op
                               ...
                               ,serverResponseDecoder: serverResponseDecoder
